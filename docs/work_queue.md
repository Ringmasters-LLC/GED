...
| GED-I18N-001  |  P1   |    P1    |     M      | MEDIUM |   TODO   | Gemini | canonical localized-country-names.json | JP as 日本 for ja              |
| GED-I18N-002  |  P1   |    P1    |     M      | MEDIUM |   TODO   | Gemini | canonical country-locales.json         | multiple locales for CH/CA     |
| GED-I18N-003  |  P1   |    P1    |     M      | MEDIUM |   TODO   | Gemini | canonical locale-writing.json          | RTL for ar, script reqs        |
| GED-I18N-004  |  P1   |    P1    |     M      | MEDIUM |   TODO   | Gemini | canonical date-time-formats.json       | cycles, week start             |
| GED-I18N-005  |  P2   |    P2    |     M      | MEDIUM |   TODO   | Gemini | canonical country-display-order.json   | picker sorting                 |
| GED-I18N-006  |  P2   |    P2    |     M      | MEDIUM |   TODO   | Gemini | canonical language-names.json          | localized lang names           |
| GED-I18N-007  |  P4   |    P4    |     M      | MEDIUM |   TODO   | Gemini | i18n Zod contracts                     | validation for new sets        |
| GED-I18N-008  |  P3   |    P3    |     M      | MEDIUM |   TODO   | Codex  | implement i18n API helpers             | getLocalizedCountryName etc    |
| GED-I18N-009  |  P4   |    P4    |     M      | MEDIUM |   TODO   | Codex  | i18n tests for JP/US/CA/CH/BE/AE/IL/HK | verify RTL/locales/names       |
| GED-COMM-001  |  P7   |    P7    |     L      | MEDIUM | DEFERRED | Gemini | @ringmasters/global-entry-commerce     | cash-rounding, tax-labels      |
| GED-FX-001    |  P7   |    P7    |     L      |  HIGH  | DEFERRED | Gemini | @ringmasters/global-entry-fx           | conversion-rules, fresh-policy |
| GED-ASSET-001 |  P7   |    P7    |     L      |  HIGH  | DEFERRED | Gemini | @ringmasters/global-entry-assets       | crypto-assets, ticker-rules    |
| GED-FIN-001   |  P7   |    P7    |     L      | MEDIUM | DEFERRED | Gemini | @ringmasters/global-entry-finance-i18n | jargon, market-terms           |
| GED-MEDIA-001 |  P7   |    P7    |     XL     |  HIGH  | DEFERRED | Gemini | @ringmasters/global-entry-media        | stations, markets, networks    |
| GED-MEDIA-002 |  P7   |    P7    |     L      |  HIGH  | DEFERRED | Gemini | media datasets (tv/radio/bands)        | all 10 datasets defined        |
| GED-MEDIA-003 |  P7   |    P7    |     M      |  HIGH  | DEFERRED | Gemini | station fields & apis                  | call signs, market lookup      |
