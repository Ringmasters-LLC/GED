...
| GED-PACKAGE-FAMILY-ROADMAP-EXPANSION-001 |    P1 | P1       | S          | LOW    | DONE     | Gemini | Define future package-family roadmap                               | satellite package boundaries and risks documented in SPEC.md                                    |
| GED-UNITS-ROADMAP-SPEC-001               |    P1 | P1       | S          | LOW    | DONE     | Gemini | Define units and measurement systems spec                          | core vs satellite boundaries for units documented in SPEC.md                                    |
| GED-P1-UNITS-001                         |    P1 | P1       | M          | MEDIUM | TODO     | Gemini | Add measurement-system preference metadata to core                 | developer can detect country preferred units for distance, weight, height, temp, and paper size |
| GED-P3-UNITS-001                         |    P3 | P3       | M          | MEDIUM | TODO     | Codex  | Add getMeasurementSystem and getPreferredUnits APIs                | APIs return stable typed unit preferences                                                       |
...
| GED-P1-I18N-001                          |    P1 | P1       | M          | MEDIUM | TODO     | Gemini | create canonical localized-country-names.json                      | country names by locale                                                                         |
| GED-P1-I18N-002                          |    P1 | P1       | M          | MEDIUM | TODO     | Gemini | create canonical country-locales.json                              | official/default/common locales by country                                                      |
| GED-P1-I18N-003                          |    P1 | P1       | M          | MEDIUM | TODO     | Gemini | create canonical locale-writing.json                               | script, direction, native-script behavior                                                       |
| GED-P1-I18N-004                          |    P1 | P1       | M          | MEDIUM | TODO     | Gemini | create canonical date-time-formats.json                            | patterns, cycles, week start, calendar                                                          |
| GED-P2-I18N-001                          |    P2 | P2       | M          | MEDIUM | TODO     | Gemini | create canonical country-display-order.json                        | sorting rules by locale/market                                                                  |
| GED-P2-I18N-002                          |    P2 | P2       | M          | MEDIUM | TODO     | Gemini | create canonical language-names.json                               | localized language names                                                                        |
| GED-P4-I18N-001                          |    P4 | P4       | M          | MEDIUM | TODO     | Gemini | create i18n schemas                                                | valid JSON schemas for i18n modules                                                             |
| GED-P3-I18N-001                          |    P3 | P3       | M          | MEDIUM | TODO     | Codex  | implement i18n API helpers                                         | getLocalizedCountryName, getLocalesByCountry, etc.                                              |
...
| GED-P6-007                               |    P6 | P6       | L          | HIGH   | PARTIAL  | Codex  | add data-refresh workflow                                          | workflow runs refresh ingestion and opens PR                                                    |
...
| GED-P7-UNITS-001                         |    P7 | P7       | XL         | HIGH   | DEFERRED | Gemini | Create @ringmasters/global-entry-units package                     | unit conversion package is separate from core                                                   |
| GED-P7-UNITS-002                         |    P7 | P7       | L          | MEDIUM | DEFERRED | Gemini | Add unit definitions (SI, Imperial, US, JP)                        | units include category, symbol, localized labels, factors                                       |
| GED-P7-UNITS-003                         |    P7 | P7       | XL         | HIGH   | DEFERRED | Gemini | Add approximate size-system conversions                            | conversions mark approximate values explicitly                                                  |
...
| GED-P7-COMMERCE-001                      |    P7 | P7       | XL         | MEDIUM | DEFERRED | Gemini | create @ringmasters/global-entry-commerce package                  | separate static commerce package                                                                |
...
| GED-P7-MEDIA-002                         |    P7 | P7       | L          | HIGH   | DEFERRED | Gemini | define TV/radio station schema                                     | name, call sign, country, market, lang, timezone, source, confidence                            |
| GED-P7-MEDIA-003                         |    P7 | P7       | L          | HIGH   | DEFERRED | Gemini | document station data source policy                                | no official authority or schedule redistribution claims                                         |
| GED-P7-MEDIA-004                         |    P7 | P7       | XL         | HIGH   | DEFERRED | Gemini | add open-compatible station metadata source adapters               | source-attributed station records                                                               |
