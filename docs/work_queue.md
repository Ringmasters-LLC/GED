...
| GED-P1-I18N-004                   |  P1   |    P1    |     M      | MEDIUM |   TODO   | Gemini | canonical date-time-formats.json                      | cycles, week start, calendar                                        |
...
| GED-P2-I18N-001                   |  P2   |    P2    |     M      | MEDIUM |   TODO   | Gemini | canonical country-display-order.json                  | picker sorting by locale/market                                     |
| GED-P2-I18N-002                   |  P2   |    P2    |     M      | MEDIUM |   TODO   | Gemini | canonical language-names.json                         | localized language names                                            |
...
| GED-P4-I18N-001                   |  P4   |    P4    |     M      | MEDIUM |   TODO   | Gemini | create i18n schemas                                   | valid JSON schemas for i18n                                         |
...
| GED-P6-007                        |  P6   |    P6    |     L      |  HIGH  | PARTIAL  | Codex  | add data-refresh workflow                             | automated ingestion                                                 |
