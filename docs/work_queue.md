...
| GED-P1-UNITS-001 | P1 | P1 | M | MEDIUM | DONE | Gemini | Add measurement-system preference metadata to core | developer can detect country preferred units for distance, weight, height, temp, and paper size |
| GED-P3-UNITS-001 | P3 | P3 | M | MEDIUM | DONE | Codex | Add getMeasurementSystem and getPreferredUnits APIs | APIs return stable typed unit preferences |
...
| GED-P3-I18N-001                          |    P3 | P3       | M          | MEDIUM | DONE     | Codex  | implement i18n API helpers                                         | getLocalizedCountryName, getLocalesByCountry, etc.                                              |
